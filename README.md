...
│            │  ┌────────────────────────┐  │  版本 ID:  [1.20.4      ]   │
│ 🎨 皮肤   │  │ 1.20.4            [X]  │  │  模组加载器: [无      ▼]     │
│ ✅ skin.png│  │ 1.20.4-forge-49.0🧩[X] │  │  提示: 安装 Forge 会同时... │
│ [选择][🗑] │  │ fabric-loader-0.15🧩[X]│  │  [📥 安装版本]              │
│            │  │                        │  │                              │
│ 📋 日志   │  │                        │  │  📋 快速选择                 │
│ [14:30:01] │  │                        │  │  ──────────────────          │
│ 环境初始化 │  │                        │  │  📦 正式版  🔬 测试版        │
...
- 右上角「🔽 启动后最小化」开关控制游戏启动后是否自动最小化启动器窗口
- 默认关闭，开启后当检测到游戏窗口出现（日志中出现 `Reloading ResourceManager:`）时自动最小化启动器到任务栏
- 设置会持久化到 `config.json`
