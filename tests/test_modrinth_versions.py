...
class TestCompressGameVersions:
    ...
    def test_legacy_full_coverage(self, mock_fetch):
        ...
        result = compress_game_versions(["1.20", "1.20.1", "1.20.2", "1.20.3", "1.20.4", "1.20.5", "1.20.6"])
    ...
    def test_legacy_merged_x(self, mock_fetch):
        ...
        mock_fetch.return_value = {16: {0, 1, 2, 3, 4, 5}, 17: {0}, 18: {0, 1, 2}, 19: {0, 1, 2, 3, 4}}
    ...
    def test_new_merged_x_versions(self, mock_fetch):
        ...
        mock_fetch.return_value = {}
        result = compress_game_versions(["26.1", "26.1.1", "26.2", "26.2.1"])
    ...
    def test_mixed_legacy_and_new(self, mock_fetch):
        ...
        mock_fetch.return_value = {21: {0, 1, 2, 3, 4}}
        result = compress_game_versions(["1.21", "1.21.1", "1.21.2", "1.21.3", "1.21.4", "26.1", "26.1.1", "26.1.2"])
